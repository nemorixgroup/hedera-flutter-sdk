...
//
// Generated from token_pause.proto.
...
///  None
class TokenPauseTransactionBody extends $pb.GeneratedMessage {
  factory TokenPauseTransactionBody({
    $0.TokenID? token,
  }) {
    final result = create();
  ...
  TokenPauseTransactionBody._();

  factory TokenPauseTransactionBody.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TokenPauseTransactionBody.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TokenPauseTransactionBody',
  ...
  TokenPauseTransactionBody clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TokenPauseTransactionBody copyWith(
          void Function(TokenPauseTransactionBody) updates) =>
      super.copyWith((message) => updates(message as TokenPauseTransactionBody))
          as TokenPauseTransactionBody;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TokenPauseTransactionBody create() => TokenPauseTransactionBody._();
  @$core.override
  TokenPauseTransactionBody createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TokenPauseTransactionBody getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenPauseTransactionBody>(create);
  static TokenPauseTransactionBody? _defaultInstance;
