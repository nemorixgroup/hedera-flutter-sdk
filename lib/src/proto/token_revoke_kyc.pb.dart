...
class TokenRevokeKycTransactionBody extends $pb.GeneratedMessage {
  ...
  TokenRevokeKycTransactionBody._();

  factory TokenRevokeKycTransactionBody.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TokenRevokeKycTransactionBody.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TokenRevokeKycTransactionBody',
  ...
  TokenRevokeKycTransactionBody clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TokenRevokeKycTransactionBody copyWith(
          void Function(TokenRevokeKycTransactionBody) updates) =>
      super.copyWith(
              (message) => updates(message as TokenRevokeKycTransactionBody))
          as TokenRevokeKycTransactionBody;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TokenRevokeKycTransactionBody create() =>
      TokenRevokeKycTransactionBody._();
  @$core.override
  TokenRevokeKycTransactionBody createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TokenRevokeKycTransactionBody getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenRevokeKycTransactionBody>(create);
