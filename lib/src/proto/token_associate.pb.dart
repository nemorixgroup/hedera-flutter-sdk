...
//
// Generated from token_associate.proto.
...
class TokenAssociateTransactionBody extends $pb.GeneratedMessage {
  ...
  TokenAssociateTransactionBody._();

  factory TokenAssociateTransactionBody.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TokenAssociateTransactionBody.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TokenAssociateTransactionBody',
  ...
  TokenAssociateTransactionBody clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TokenAssociateTransactionBody copyWith(
          void Function(TokenAssociateTransactionBody) updates) =>
      super.copyWith(
              (message) => updates(message as TokenAssociateTransactionBody))
          as TokenAssociateTransactionBody;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TokenAssociateTransactionBody create() =>
      TokenAssociateTransactionBody._();
  @$core.override
  TokenAssociateTransactionBody createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static TokenAssociateTransactionBody getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TokenAssociateTransactionBody>(create);
